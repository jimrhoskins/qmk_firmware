...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[SYMNUM] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS,  KC_GRV,          KC_LBRC,         KC_RBRC,         KC_LCBR,         KC_RCBR,   KC_NUHS,  KC_1,         KC_2,         KC_3,         KC_DOT,          KC_BSPC,
                                                    TO(0),           KC_NO,           KC_NO,     KC_ESC,   KC_ENT,       KC_0
    ),
